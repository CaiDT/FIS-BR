...
def get_attention_list():
    attention_list = network.ATTENTION_LIST
    network.ATTENTION_LIST = []
    return attention_list

def get_STA_attention_list():
    # STA attention
    # attention_list = network.ATTENTION_LIST
    # network.ATTENTION_LIST = []
    Temporal_attention_list = network.TemporalAttention_List
    network.TemporalAttention_List = []
    Spatial_attention_list = network.SpatialAttention_List
    network.SpatialAttention_List = []

    return [Temporal_attention_list, Spatial_attention_list]
